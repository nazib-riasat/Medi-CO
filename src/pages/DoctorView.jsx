    ...
    return (
      <div style={{
        ...
        <p style={{ fontSize: 14, color: '#888' }}>
          This QR code has expired. Please ask the caregiver to generate a new one.
        </p>
      </div>
    )
  }
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          ...
          background: timeLeft < 300 ? '#fdecea' : 'rgba(255,255,255,0.15)',
          padding: '6px 14px', borderRadius: 20
        }}>
          <span style={{ fontSize: 14 }}>⏱</span>
          <span style={{
            fontSize: 15, fontWeight: 700,
            color: timeLeft < 300 ? '#c62828' : 'white'
          }}>
            {formatTime(timeLeft)}
          </span>
          <span style={{
            fontSize: 12,
            color: timeLeft < 300 ? '#c62828' : 'rgba(255,255,255,0.8)'
          }}>remaining</span>
        </div>
      </nav>
      ...
      <div style={{ padding: 20, paddingBottom: 80 }}>
        ...
        {patient && (
          <div style={{
            ...
            <div style={{
              ...
              background: '#f0faf5', border: '2px solid #1D7C57',
              overflow: 'hidden', flexShrink: 0,
              display: 'flex', alignItems: 'center', justifyContent: 'center'
            }}>
              {patient.profile_pic_url ? (
                <img src={patient.profile_pic_url} alt="patient"
            ...
            <div>
              <h2 style={{ fontSize: 18, fontWeight: 700, color: '#2d2d2d', marginBottom: 4 }}>
                {patient.full_name}
              </h2>
        ...
        <input
          ...
          style={{
            ...
            padding: '0 16px', border: '1px solid #ddd',
          ...
          {['All', 'lab_report', 'scan', 'prescription'].map(f => (
            <button
              ...
              style={{
                ...
                border: activeFilter === f ? '2px solid #1D7C57' : '2px solid #e0e0e0',
              ...
              <div
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ fontSize: 12, color: '#888' }}>
                    {FILTER_LABELS[record.record_type]} · {record.record_date
        ...
        {activeMeds.length === 0 ? (
          ...
          <div style={{
            background: 'white', borderRadius: 14,
            border: '1px solid #e0e0e0', overflow: 'hidden', marginBottom: 20
          }}>
            {activeMeds.map((med, i) => (
              <div key={med.medication_id} style={{
                padding: '14px 16px',
                borderBottom: i < activeMeds.length - 1 ? '1px solid #f0f0f0' : 'none',
                display: 'flex', flexDirection: 'column', gap: 4
              }}>
                <p style={{ fontSize: 15, fontWeight: 600, color: '#2d2d2d' }}>
                  {med.medicine_name}
                </p>
                ...
                {med.notes && (
                  <p style={{ fontSize: 12, color: '#aaa' }}>{med.notes}</p>
                )}
              </div>
            ))}
          </div>
            ...
            <div style={{
              ...
              {pastMeds.map((med, i) => (
                <div key={med.medication_id} style={{
                  ...
                  borderBottom: i < pastMeds.length - 1 ? '1px solid #f0f0f0' : 'none'
                }}>
                  <p style={{ fontSize: 14, fontWeight: 500, color: '#555' }}>
                    {med.medicine_name}
                  </p>
                  <p style={{ fontSize: 12, color: '#888' }}>
                    {med.dose} · {med.timing} · Discontinued
                  </p>
                </div>
              ))}
            </div>
